package com.asir.tris.admusuario.controller;
...
public class AdmUsuarioController {
	...
	@ResponseBody
	public List<UsuarioDto> cargaGrid(Model model, @ModelAttribute UsuarioDto dto){
